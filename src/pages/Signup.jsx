  ...
  return (
    ...
    <div class="w-full flex flex-col items-center justify-center">
        ...
        <form class="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <p class="text-sm text-gray-500/90 mt-3">Welcome! Please sign up to continue</p>
            ...
            <p class="text-gray-500/90 text-sm mt-4">Already have an account? <Link to='/login' class="text-[#001834] hover:underline" href="#">Login</Link></p>
        </form>
    </div>
</div>
  )
