  ...
  return (
    ...
    <div class="w-full flex flex-col items-center justify-center">
        ...
        <form class="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <p class="text-sm text-gray-500/90 mt-3">Welcome! Please login to continue</p>
            ...
            <div class="flex items-center gap-4 w-full my-5">
                ...
                <p class="w-full text-nowrap text-sm text-gray-500/90">or login with email</p>
                <div class="w-full h-px bg-gray-300/90"></div>
            </div>
            ...
            <button type="submit" class="mt-8 w-full h-11 rounded-full cursor-pointer text-white bg-[#001834] hover:opacity-90 transition-opacity">
                Login
            </button>
            <p class="text-gray-500/90 text-sm mt-4">Don’t have an account? <Link to='/signup' class="text-[#001834] hover:underline" href="#">Sign up</Link></p>
        </form>
    </div>
</div>
  )
